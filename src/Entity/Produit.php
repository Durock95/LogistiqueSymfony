...
class Produit
{
    ...
    #[Assert\Length(max: 50, maxMessage: 'La référence doit contenir au plus 20 caractères')]
    private ?string $reference = null;

    #[ORM\Column(length: 50)]
    #[NotBlank(message: 'Le type de conditionnement est obligatoire')]
    #[Assert\Length(max: 50, maxMessage: 'Le type de conditionnement doit contenir au plus 30 caractères')]
    private ?string $typeConditionnement = null;

    #[ORM\Column]
    #[NotBlank(message: 'La quantité est obligatoire')]
    #[Assert\Positive(message: 'La quantité doit être supérieur ou égale à 1')]
    private ?int $quantite = null;

    #[ORM\Column(length: 30)]
    #[NotBlank(message: "L'emplacement est obligatoire")]
    #[Assert\Length(max: 50, maxMessage: "L'emplacement doit contenir au plus 30 caractères")]
    private ?string $emplacement = null;

    #[ORM\Column] // (type: Types::DECIMAL, precision: 7, scale: 2)
    #[NotBlank(message: 'La quantité est obligatoire')]
    #[Assert\PositiveOrZero(message: 'La quantité doit être positif ou nul')]
    private ?int $prix = null;

    #[ORM\Column]
    #[NotBlank(message: 'Le quota est obligatoire')]
    #[Assert\Positive(message: 'Le quota doit être supérieur ou égale à 1')]
    private ?int $quota = null;

    #[ORM\Column]
    #[NotBlank(message: 'Le stock est obligatoire')]
    #[Assert\Positive(message: 'Le stock doit être positif ou nul')]
